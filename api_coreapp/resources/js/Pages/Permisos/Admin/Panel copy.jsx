...
export default function PanelAdmin() {
    ...
    return (
        <BasePanel titulo="Panel de Control">
            ...
            <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 24, fontWeight: 700, color: 'var(--color-text-primary)', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 12 }}>
                <span style={{ width: 6, height: 24, backgroundColor: 'var(--color-terra)', borderRadius: 4 }}></span>
